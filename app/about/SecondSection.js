    ...
    return (
        ...
        <div className={styles.company} >
            ...
            <div className={styles.company__imageWrapper} >
                <img src="/about-second-section-image.webp" alt="company picture" className={styles.company__image} />
            </div>
        </div>
             <p className={styles.secondSection__endText } >Uchha Himal Product Pvt Ltd — where quality meets craftsmanship, and tradition embraces innovation.</p>
        </div>
    )
}
